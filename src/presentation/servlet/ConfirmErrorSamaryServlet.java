...
/**
 * エラーサマリの入力内容を確認するサーブレット
 */
@WebServlet("/ConfirmErrorSamaryServlet")
public class ConfirmErrorSamaryServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// 確認画面にフォワード
		request.getRequestDispatcher(Constance.CONFIRM_ERROR_SAMARY_JSP).forward(request, response);
